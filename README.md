...
## Overview
The goal of this project is to create a production ready Extraction, Load, Transform (ELT) pipeline for USD's MS ADS Practical Data Engineering course. ADS507.
